...
--
-- Host: localhost
-- Generation Time: Oct 07, 2013 at 04:15 AM
...
--
-- Table structure for table `gaussdis`
--

CREATE TABLE IF NOT EXISTS `gaussdis` (
  `data` float NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `gaussdis`
--

INSERT INTO `gaussdis` (`data`) VALUES
(8.5),
(8.5),
(10),
(9.5),

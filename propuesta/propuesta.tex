...
Query de MySQL & Para interpretar los datos, es necesario acomodar, o bien obtener información importante para generar la gráfica. Para se utiliza el motor de MySQL para aprovechar dicha facilidad \\

\\

Media & Obtiene la media de un conjunto de datos. \\

\\

Desviación estándar & Obtiene la desviación estándar de un conjunto de datos. \\

\\

Varianza & Obtiene la varianza de un conjunto de datos.\\

\\ %esta metiendo dos espacios ??

Distribución gaussiana & Devuelve la distribución gaussiana de mejor ajuste a los datos.\\

\\

KDE & Genera un Kernel Density Estimation de un conjunto de datos mediante gnuplot. \\

\\

Jitterplot & Genera un gráfico tipo jitterplot de un conjunto de datos mediante gnuplot. \\

\\

PDF & Grafica la función de densidad discreta de un conjunto de datos. \\

\\

CDF & Grafica la función de distribución discreta de un conjunto de datos. \\
